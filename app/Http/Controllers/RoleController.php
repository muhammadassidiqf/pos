...
class RoleController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('roles.index')->with('success', "Roles has been successfully added!");
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        $role->syncPermissions($permissions);
        $role->save();
        return redirect()->route('roles.index')->with('success', "Roles has been successfully updated!");
    }
