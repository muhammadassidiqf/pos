<form class="form" action="{{ route('product.update', encrypt($data->id)) }}" method="POST" id="edit_product_modal_form"
    enctype="multipart/form-data">
    @csrf
    @method('PUT')
    <div class="scroll-y me-n7 pe-7" id="edit_product_modal_scroll" data-kt-scroll="true"
        data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto"
        data-kt-scroll-dependencies="#edit_product_modal_header" data-kt-scroll-wrappers="#edit_product_modal_scroll"
        ...
        <div class="fv-row mb-7">
            ...
            <select class="form-select form-select-solid" data-control="select2" data-placeholder="Select an option"
                data-allow-clear="true" name="category" id="category" required>
        ...
        <div class="fv-row mb-7">
            ...
            <input type="text" class="form-control form-control-solid price-money" value="{{ $data->price }}"
                name="price" required />
        </div>
        <div class="fv-row mb-7">
            <label class="required fs-6 fw-bold mb-2">Description</label>
            <textarea type="text" class="form-control form-control-solid" name="description" required />{{ $data->description }}</textarea>
        </div>
        <div class="fv-row mb-7">
            <div class="row">
            ...
            <div class="image-input image-input-outline image-input-empty" data-kt-image-input="true"
                style="background-image: url('{{ !empty($data->image) ? asset('storage/img/product/' . $data->image) : asset('media/svg/avatars/blank.svg') }}')">
        ...
        <div class="fv-row mb-5 d-flex flex-center">
            <button type="reset" id="edit_product_modal_cancel" class="btn btn-light me-3" data-bs-dismiss="modal"
                aria-label="Close">Discard</button>
            <button type="submit" id="edit_product_modal_submit" class="btn btn-primary">
...
<script>
    $(document).ready(function() {
        var checkupdateFieldRow = () => {
            e = document.querySelector("#edit_product_modal_scroll"),
                t = document.querySelector("#edit_product_modal_submit"),
